...
public class TriumBlock extends MileniumModElements.ModElement {
	@ObjectHolder("milenium:trium_ore")
	public static final Block block = null;

	public TriumBlock(MileniumModElements instance) {
		super(instance, 27);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("milenium:trium_ore_match"), () -> CustomRuleTest.codec);
