...
public class TriumswordItem extends MileniumModElements.ModElement {
	@ObjectHolder("milenium:triumsword")
	public static final Item block = null;

	public TriumswordItem(MileniumModElements instance) {
		super(instance, 29);
	}
	...
	public void initElements() {
		...
		}, 3, 10f, new Item.Properties().group(MileniumItemGroup.tab)) {
		}.setRegistryName("triumsword"));
	}
}
