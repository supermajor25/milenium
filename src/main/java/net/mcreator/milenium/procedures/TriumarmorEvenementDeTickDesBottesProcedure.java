...
public class TriumarmorEvenementDeTickDesBottesProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				MileniumMod.LOGGER.warn("Failed to load dependency entity for procedure TriumarmorEvenementDeTickDesBottes!");
			return;
		}
